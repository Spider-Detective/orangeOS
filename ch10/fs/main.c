...
PUBLIC void task_fs() {
    ...
    while (1) {
        ...
        // do nothing if receive SUSPEND_PROC
...
PRIVATE void mkfs() {
    ...
    pi->i_size = DIR_ENTRY_SIZE * 5; // 5 files: '/' and 3 dev_tty and .tar
...
// increase the reference count for the child process when fork happens
PRIVATE int fs_fork() {
    int i;
